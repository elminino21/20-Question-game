...
public class SortedArrayCollection<T> implements CollectionInterface<T> 
{
  ...
  public String toString()
  {
	  ...
	  for(int i = 0; i < numElements && i < DEFCAP; i++)
	  {
		  TemptTostring.append( elements[i].toString() );
	  }
  ...
  public int greater(T element)
  {
	  ...
	  this.find(element);
	  return numElements -location ;
  }
  
  public SortedArrayCollection<T> combine (SortedArrayCollection<T> other)
  {
	  if( (other.size() + this.size()) > origCap )
